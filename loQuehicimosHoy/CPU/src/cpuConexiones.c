...
int conectarAPlanificador(char* puerto) {
	...
	getaddrinfo(ipSwap, puerto, &hints, &serverInfo);	// Carga en serverInfo los datos de la conexion

	planificadorSocket = socket(serverInfo->ai_family, serverInfo->ai_socktype,	serverInfo->ai_protocol);
